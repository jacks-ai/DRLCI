...
def ParseArgs():
    ...
    parser.add_argument('--one_hop_weight', type=float, default=2.5, help='一跳困难负样本权重倍数')
    parser.add_argument('--two_hop_weight', type=float, default=1.5, help='二跳困难负样本权重倍数')
    ...
    parser.add_argument('--use_joint_encoding', type=lambda v: str(v).lower() in {'1', 'true', 'yes'}, default=False,
