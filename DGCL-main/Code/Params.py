...
def ParseArgs():
    ...
    parser.add_argument('--num_neg_mul', type=int, default= 0, help='num_neg_mul')
    ...
    parser.add_argument('--pretrained_drug_embed_path', type=str, default="/mnt/data/huangpeng/DGCL/DGCL-main/Data/DrugBank/drug_text/bert_drugbank_emd_cls.npy", help='')
    ...
    parser.add_argument('--pretrained_gene_embed_path', type=str, default="/mnt/data/huangpeng/DGCL/DGCL-main/Data/DrugBank/gene_text/bert_drugbank_gene_emd_cls.npy", help='')
